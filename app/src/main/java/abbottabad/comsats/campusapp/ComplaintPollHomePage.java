...
/**
 * This project CampusApp is created by Kamran Ramzan on 04-Jan-17.
 */

public class ComplaintPollHomePage extends AppCompatActivity implements View.OnClickListener, RippleView.OnRippleCompleteListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String APPLICATION_STATUS = sharedPreferences.getString("APPLICATION_STATUS", null);
        if (APPLICATION_STATUS != null) {
            if (APPLICATION_STATUS.equals("FOOD")) {
                setContentView(R.layout.complaint_poll_home_page);
                Toolbar toolbar = (Toolbar) findViewById(R.id.complaintpoll_toolbar);
                setSupportActionBar(toolbar);
                RippleView BTN_pendingComplaints = (RippleView) findViewById(R.id.BTN_pendingComplaints);
                BTN_pendingComplaints.setOnRippleCompleteListener(this);
                RippleView BTN_processedComplaints = (RippleView) findViewById(R.id.BTN_processedComplaints);
                BTN_processedComplaints.setOnRippleCompleteListener(this);
            } else {
                ...
                ET_regID.setText(sharedPreferences.getString("REG_ID", ""));
                ET_contact = (EditText) findViewById(R.id.ET_contact);
                ET_contact.setText(sharedPreferences.getString("CONTACT", ""));
    ...
    void populateSpinner() {
        ...
        ArrayAdapter<CharSequence> spinnerAdapter = ArrayAdapter.createFromResource(ComplaintPollHomePage.this,
                        ...
                        if (validation.validatePhoneNumber(contact)) {
                            if (imageString != null) {
                                if (adminOption != 0) {
                                    switch (adminOption) {
                                        case 1: {
                                            new ComplaintPollModal(ComplaintPollHomePage.this).sendComplaint(name,
                                                    regID,
                                                    contact,
                                                    description,
                                ...
                                Toast.makeText(ComplaintPollHomePage.this, "Select image", Toast.LENGTH_SHORT).show();
                        } else
                            Toast.makeText(ComplaintPollHomePage.this, "Invalid contact #", Toast.LENGTH_SHORT).show();
                    } else
                        Toast.makeText(ComplaintPollHomePage.this, "Invalid registration id", Toast.LENGTH_SHORT).show();
                } else
                    Toast.makeText(ComplaintPollHomePage.this, "Invalid name", Toast.LENGTH_SHORT).show();
                break;
            }
        ...
        if (requestCode == REQUEST_SELECT_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                if (bitmap != null) {
                    ...
                    Toast.makeText(ComplaintPollHomePage.this, "Image not selected", Toast.LENGTH_LONG).show();
    ...
    public void onComplete(RippleView rippleView) {
        switch (rippleView.getId()) {
            ...
            case R.id.BTN_pendingComplaints: {
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putInt("COMPLAINT_TYPE", 1);
                editor.apply();
                Intent intent = new Intent(ComplaintPollHomePage.this, ComplaintPollView.class);
                startActivity(intent);
                break;
            }
            case R.id.BTN_processedComplaints: {
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putInt("COMPLAINT_TYPE", 2);
                editor.apply();
                Intent intent = new Intent(ComplaintPollHomePage.this, ComplaintPollView.class);
                startActivity(intent);
                break;
